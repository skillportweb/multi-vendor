...
export default function WeeklySalesChart() {
  ...
  return (
    <div className="dark:bg-slate-700 bg-slate-50 p-8 rounded-lg shadow-md">
      <h2 className="text-xl font-bold mb-4 text-slate-800 dark:text-slate-100">Weekly Sales</h2>
      <div className="p-4">
        {/* Tab */}
                ...
                <button
                  ...
                  className={
                    chartToDisplay === tab.type
                      ...
                      : "inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-700 hover:border-gray-100 dark:hover:text-gray-100 text-slate-800 "
                  }
                >
                  {tab.title}
                </button>
